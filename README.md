...
## 2) Data Source, Download, and Preparation
BouwBot NL uses the **3DBAG** dataset (3D building models of the Netherlands) (https://3dbag.nl/en/download).
...
This notebook:
- Download from the official 3DBAG website: https://3dbag.nl/en/download
- loads the nationwide GeoPackage
- clips to Utrecht boundary
- exports a smaller GeoPackage suitable for local analysis


### Download the pre-clipped Utrecht dataset (optional)
If you don’t want to run the clipping step, you can download the already clipped Utrecht dataset here:
