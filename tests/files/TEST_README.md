...
├── test_app.py                 # Test suite (this file)
...
### Run with Coverage
```bash
pytest test_app.py -v --cov=app --cov=tools
```

### Run with Detailed Output
```bash
pytest test_app.py -vv --tb=short
```
...
**Solution:** Run pytest from the project root directory where `app.py` is located.
